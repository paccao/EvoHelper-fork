...
// Ancient Soul
  ...
  "Ruby": {
    ...
    icon: "Ruby",
    description: "A very rare gemstone with very high value. Glows in crimson red and shines very brightly.",
    effects: [],
    source: "Ancient Soul",
  },
  "Diamond": {
    ...
    icon: "GoldenFragment",
    description: "The rarest gemstone to be ever discovered. It shimmers very brightly and makes light bend on its surface.",
    effects: [],
    source: "Ancient Soul",
  },
}
